...
-- Fuzzyfinding
utils.nnoremap('<C-p>', [[<cmd>lua require'gebhartn.plugins.nvim-telescope.commands'.find_files_m()<CR>]])
utils.nnoremap('<C-g>', [[<cmd>lua require'gebhartn.plugins.nvim-telescope.commands'.live_grep()<CR>]])
